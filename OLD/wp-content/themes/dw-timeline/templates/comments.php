    ...
    <nav>
      <ul class="pager">
        <?php if (get_previous_comments_link()) : ?>
          <li class="previous"><?php previous_comments_link(__('&larr; Comentarios anteriores', 'dw-timeline')); ?></li>
        <?php endif; ?>
        <?php if (get_next_comments_link()) : ?>
          <li class="next"><?php next_comments_link(__('Comentarios siguientess&rarr;', 'dw-timeline')); ?></li>
        <?php endif; ?>
      </ul>
    </nav>
    <?php endif; ?>
...
<?php if (!have_comments() && !comments_open() && !is_page() && post_type_supports(get_post_type(), 'comments')) : ?>
  <section id="comments">
    <div class="alert alert-warning">
      <?php _e('No se puede comentar.', 'dw-timeline'); ?>
    </div>
  </section><!-- /#comments -->
<?php endif; ?>
<?php
